...
public class Ex23_Main {
    ...
    //------------------------------------------------------------
	// Q. 부부가 식사중에 여성이 말했다.
	// "여보 마트가서 우유사고 만약에 아보카도 있으면 6개 사요"
	...
	//       >호출 결과가 ture라면 milkCount를 6으로
    //       >호출 결과가 false라면 milkCount를 1로 할당
    // - milkCount 필드에 대한 getter를 작성하세요
		
		Ex23_3_SuperMarket market = new Ex23_3_SuperMarket();
		
		// 아보카도가 있는 경우
		//Ex23_2_HasAvocado c1 = Ex23_2_HasAvocado();
