...
public class Ex21_3_Sorceress extends Ex21_3_Character{
	//21_Main
	// Character 클래스 상속 받습니다.
	//Ex21_3_CharacterAbility ca;
	
	// 소서리스 객체 생성시 힘10, 민첩7, 지력 35로 생성됩니다.
public Ex21_3_Sorceress(Ex21_3_CharacterAbility ca) {
		ca.setStr(10);
		ca.setDex(7);
		ca.setKnowledge(35);
	...
	public void attack(Ex21_3_CharacterAbility ca) {
		if(ca.getHp() < 10) {
			...
			System.out.println("없는 꼬리를 휘두릅니다.");
	...
	public void skill(Ex21_3_CharacterAbility ca) {
		if(ca.getMp() < 23) {
			...
			System.out.println("이빨 드러내기를 사용합니다.");
	...
	// - 지력 5 증가
	public void levelUp(Ex21_3_CharacterAbility ca) {
