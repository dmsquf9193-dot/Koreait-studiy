...
public class Ex08_Array {
	...
	public static void main(String[] args) {
		...
		// 인덱스 (Index)
		// - 배열의 요소에 접금하기 위해 사용되는 번호 (요소의 위치를 의미함)
		// - 인덱스는 0부터 시작
		int[] arr = new int[4]; // 4만큼의 크기를 가진 배열 선언과 생성
        ...
        System.out.println("0번 인덱스 조회 : " +  arr[0]); // 0번 인덱스의 요소를 조회하겠다(가지고옴)
