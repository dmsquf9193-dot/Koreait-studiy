...
public class Ex01_Variable {
	...
	public static void main(String[] args) {
		...
		int age = 19;                  // 4byte
		long population = 8_000_000_000L; // 8byte 언더바 넣어도 됨
		...
		// 자동 형변환 (암시적 형변환
		// - 개발자가 직점 형변환을 해주지 않아도 컴파일 과정에서 자동으로 변환됨
		// - 범위가 작은 자료형 -> 범위가 큰 자료형
		byte num3 = 10;
		int num4 = num3;   // 1byte -> 4byte로 변환
		...
		float floatNumber = longNumber;  // 8byte -> 4byte로 변환
		...
		// ---------------------------------------------------------------------------
		 ...
		 System.out.println("\"Hello, World!\"");
		 // "" 와 같이 출력하려면 역슬레시(그 다음에 오는 것은 문자가 와야함)
		 ...
		 //    > 파일 상단에 import java.utill.Scanner;
		 // 2. 객체 생성하기
		 ...
		 // 3. nextDouble();
		 // 4. next();
		 //    -> 단어를 처리할 대 사용되며 공백전까지 입력받은 데이터를 반환
		 // 5. nextLine(); ->앞으로 많이쓰임
		 //    -> 문자열을 처리할 대 사용되며 \n을 기준으로 데이터를 반환
		 //       (엔터를 입력하면 \n이 들어감)
