...
#   - Dense(1) : 레이어를 1개만 사용하겠다. ( 출력노드 1개, 결과값도 1개)
...
# 3. 컴파일 (학습 과정)
#   - compile : " 학습을 어떻게 할거냐" 정의하는 단계
#   - optimizer : 어떤 알고리즘을 사용할지 정함
#       > learning_rate=0.01 : 한번 업데이트 할 때 마다 얼마나 이동할지
...
for epoch in range(epochs):
    history = model.fit(X, Y, epochs=1, verbose=0) # 실제로 학습하는 부분
